...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        {
            var indexer = new Indexer(ref array, 1, 2);
        ...
        {
            Assert.Equals(typeof(ArgumentException), new Indexer(ref array, -1, 3));
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void FailWithWrongArguments2()
        {
            Assert.Equals(typeof(ArgumentException), new Indexer(ref array, 1, -1));
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void FailWithWrongArguments3()
        {
            Assert.Equals(typeof(ArgumentException), new Indexer(ref array, 1, 10));
        }
        [TestMethod]
